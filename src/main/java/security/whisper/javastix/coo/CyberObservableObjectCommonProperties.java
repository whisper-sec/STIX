...
public interface CyberObservableObjectCommonProperties extends GenericValidation {
    ...
    /**
     * The ID of this Cyber Observable Object. Must be deterministically generated based on the observable's properties.
     * Format: [type]--[UUID based on content]
     * This is required by BundleableObject interface.
     */
    String getId();
