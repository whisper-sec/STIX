...
public interface Ipv6AddressCoo extends CyberObservableObject {
    ...
    /**
     * Deterministically generates the ID for this IPv6 address based on its value.
     */
    @Override
    @Value.Derived
    default String getId() {
        return "ipv6-addr--" + UUID.nameUUIDFromBytes(getValue().getBytes(StandardCharsets.UTF_8));
    }
