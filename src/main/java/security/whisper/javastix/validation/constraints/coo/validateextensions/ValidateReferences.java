package security.whisper.javastix.validation.constraints.coo.validateextensions;
 ...
 * This annotation will ensure that the extension is only used on the classes that implement {@link AllowedParents} with the proper configuration.
 */
@Documented
