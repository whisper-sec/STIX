...
import com.noctisnet.stix.coo.types.WindowsPeOptionalHeaderObj;
import com.noctisnet.stix.coo.types.WindowsPeSectionObj;
...
import com.noctisnet.stix.validation.constraints.hashingvocab.HashingVocab;
...
import com.noctisnet.stix.vocabulary.vocabularies.HashingAlgorithms;
...
public interface WindowsPeBinaryFileExtensionExt extends CyberObservableExtension {
    ...
    default Set<WindowsPeSectionObj> getSections() {
        return null;
    }
